...
<script>
    $(document).ready(function () {
        ...
        $(document).on('keypress', '#part_tipe_filter, #part_nama_filter, #part_harga_filter', function (event) {
            if (event.key === "Enter") {
                searchPart();
            }
        });

        $(document).on('keypress', '#material_nama_filter, #material_jenis_filter, #material_harga_filter', function (event) {
            if (event.key === "Enter") {
                searchMaterial();
            }
        });
